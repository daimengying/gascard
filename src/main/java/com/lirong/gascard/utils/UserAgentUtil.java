...
public class UserAgentUtil {
	...
	public static UserAgent getUserAgent(String userAgent) {
		...
		if (userAgent.contains("Windows")) {//主流应用靠前
			 ...
			 */
			if (userAgent.contains("Windows NT 6.2") || userAgent.contains("Windows NT 6.3") ) {//Windows 8
				...
				return judgeBrowser(userAgent, "Windows", null , null);
			}
			...
			if (userAgent.contains("iPod")) {
				...
				return judgeBrowser(userAgent, "Mac OS X", null , null);
			}
		}else{
			return judgeBrowser(userAgent, "未知", null , null);
		}
	}
